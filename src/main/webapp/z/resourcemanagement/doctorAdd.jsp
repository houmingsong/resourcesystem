                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            ...
                            <form action="CashStatement/CashStatementAdd.lovo" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="phone" class="form-control" id="inputEmail4" placeholder="1xxxxxxxxxx" required="">
                                    </div>
                                </div>
                                </fieldset>
