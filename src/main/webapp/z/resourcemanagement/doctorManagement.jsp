...
<base href="<%=basePath%>">
   ...
   <script src="z/js/jquery-2.1.4.js"></script> 
     ...
     function data(data){
    		...
    		var InventoriesId = e.inventoriesId;
    		
    		var tr = "<tr><td>"+ eventName +"</td><td>"+ eventNum +"</td><td><a href='CashStatement/CashStatementdelet.lovo?InventoriesId="
			+ InventoriesId + "'>删除</a></td></tr>";
