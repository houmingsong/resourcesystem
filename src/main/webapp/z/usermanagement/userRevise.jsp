                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            ...
                            <form action="User/UserRevisea.lovo?id=${list[0].id }" method="post">
                                <div class="form-group row">
                                    
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">密码</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="passworda"  class="form-control" id="inputEmail4"  required="">
                                    </div>
                                    <label for="inputEmail3" name="passwordb" class="col-sm-2 col-form-label">确认密码</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <input type="submit" class="btn btn-primary"   onclick="judge">
                                    </div>
                                </div>
                            </form>
                        </div>
